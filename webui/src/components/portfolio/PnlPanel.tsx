...
export function PnlPanel({ selectedId }: PnlPanelProps) {
  ...
  if (pnlLoading) return (
    <div className="card p-12 text-center text-slate-500">Loading P&L...</div>
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card p-6">
          ...
          <div className="h-2 bg-inset rounded-full mt-3 overflow-hidden">
      ...
      <div className="card p-12 text-center items-center">
        ...
        <div className="inline-block px-4 py-2 bg-inset rounded-lg text-slate-500 text-sm font-mono">v2.6.0</div>
      </div>
    </div>
  );
}
