...
export function PortfolioDonut({ summary }: PortfolioDonutProps) {
  ...
  return (
    <div className="card" data-card="portfolio" style={{ height: '100%', minHeight: 0, overflow: 'hidden' }}>
      ...
      {/* P1-5: zero-balance → empty ring + empty-state message */}
      {isEmpty ? (
        <div className="card-body" style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ position: 'relative', width: 160, height: 160 }}>
              ...
              <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <span style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'var(--font-mono)' }}>$0</span>
              </div>
            </div>
          </div>
          <div className="port-body">
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: 12.5, marginTop: 4 }}>No holdings yet</p>
            <a href="#" style={{ fontSize: 12.5, fontWeight: 600, color: 'var(--accent-cyan)' }}>Add a portfolio →</a>
          </div>
        </div>
      ) : (
        <>
